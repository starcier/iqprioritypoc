  ...
  api.loadSource(async (actions) => {
    ...
    for (const air of data.records) {
      collection.addNode({
        ...
        litUnlitigatedVal: air.fields.litigation_unlitigated_value,
        litAttorneyVal: air.fields.litigation_attorney_value,
        litSuitVal: air.fields.litigation_suit_value,
